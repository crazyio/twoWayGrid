...
//	//}
	...
	//        // TODO1: Should we check for acceptFilter()?
	...
	//        // TODO1: The 20 below should come from the theme
	//        // TODO1: And the gravity should be defined in the theme as well
	...
	public void setScrollDirectionPortrait(int direction) {
		...
		if (tempDirection != mScrollVerticallyPortrait) {
			setupScrollInfo();
			// TODO1 or requestLayoutIfNecessary()?
			resetList();
			mRecycler.clear();
		}
	}
		...
		public void onWindowFocusChanged(boolean hasWindowFocus) {
			...
			if (!hasWindowFocus) {
				...
				if (mFlingRunnable != null) {
					...
					// TODO1: this doesn't seem the right way to do this.
					if (getScrollY() != 0) {
	...
	class VerticalTouchHandler extends TouchHandler {
		...
		boolean trackMotionScroll(int deltaY, int incrementalDeltaY) {
			...
			// FIXME1 account for grid vertical spacing too?
	...
	class HorizontalTouchHandler extends TouchHandler {
		...
		boolean trackMotionScroll(int delta, int incrementalDelta) {
			...
			// FIXME1 account for grid horizontal spacing too?
